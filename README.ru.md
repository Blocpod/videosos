# AIVRA - Видеоредактор с открытым исходным кодом на базе AI
...
**[🚀 Попробовать демо](https://aivra.app)** | [🇬🇧 English version](./README.md)

## Скриншоты

### Главная страница
![AIVRA Главная страница](./public/screenshot-landing.png)

### Видеоредактор
![AIVRA Видеоредактор](./public/screenshot-app.png)
...
AIVRA поддерживает несколько AI провайдеров одновременно:
...
Мы активно работаем над улучшением AIVRA! Вот функции и улучшения, которые мы планируем:
...
Мы приветствуем участие разработчиков любого уровня! Будь то исправление багов, добавление новых функций, улучшение документации или обсуждение идей - ваша помощь делает AIVRA лучше для всех.
